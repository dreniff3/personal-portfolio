    ...
    return (
        <>
            <div className="bio">
                ...
                <div className={hideText ? "info-description-container" : "info-description-container show"}>
                ...
                <button className="show-btn" onClick={onClick}>{hideText ? "..." : <IoIosArrowUp />}</button>
